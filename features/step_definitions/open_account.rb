...
Quando('realiza a abertura de uma conta corrente') do
    @open_account_page.select_origin_account.first.click
    @open_account_page.set_checking_account.click
    sleep 1
    @open_account_page.btn_open_account.click
    @account_type = 'CHECKING'
end

Quando('realiza a abertura de uma conta poupança') do
    @open_account_page.select_origin_account.first.click
    @open_account_page.set_savings_account.click
    sleep 1
    @open_account_page.btn_open_account.click
